...
const { cacheBlocksInfo, cacheBlocksInfoSize, cacheBlockData, cacheBlockDataSize, port, peerAnnounceAddr } = require('./config')
...
const blocksInfoCache = new LRUCache(cacheBlocksInfoSize)
